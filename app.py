...
# --- CONFIGURACIÓN ---
st.set_page_config(page_title="LabMind 91.6", page_icon="🧬", layout="wide")
...
with col_left:
    ...
    modelo_seleccionado = st.selectbox("Elige la versión de Gemini:", opciones_modelos)
        ...
        if btn_analizar:
            ...
            with st.spinner(f"🧠 Computando Biomecánica Autónoma ({modo})..."):
                ...
                try:
                    ...
                    # AQUÍ UTILIZAMOS EL MODELO QUE HAS SELECCIONADO EN EL DESPLEGABLE
