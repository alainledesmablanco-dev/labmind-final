...
with col_c:
    ...
    # --- CONTEXTO HOSPITALIZACIÓN POR DEFECTO (index=1) ---
    ...
    if modo == "📚 Agente Investigador (PubMed)":
        ...
        # --- EXPANDERS CERRADOS PARA NOTAS Y VOZ ---
        ...
        with st.expander("🎙️ Adjuntar Nota de Voz", expanded=False):
            # st.audio_input es el componente nativo moderno (incluye reproductor y papelera para borrar)
    ...
    if btn_analizar:
        ...
        with st.spinner("Procesando datos (Razonamiento en Cadena activado)..."):
            try:
                ...
                # --- PROMPT MAESTRO CON RAZONAMIENTO EN CADENA (CoT) ---
                if sam_utilizado:
