    ...
    if btn_analizar:
        ...
        with st.spinner("Procesando datos (Razonamiento en Cadena activado)..."):
            try:
                ...
                # --- PROMPT MAESTRO CON RAZONAMIENTO EN CADENA (CoT) Y BBOX CORREGIDO ---
                if sam_utilizado:
                ...
                1. EXAMEN VISUAL: Describe brevemente qué estructuras anatómicas ves.
                ...
                <details class="action-box" open><summary>⚡ ACCIÓN INMEDIATA</summary><p>[Plan]</p></details>
                <details class="{'pubmed-box' if 'PubMed' in modo else 'material-box'}" open><summary>🛠️ TRATAMIENTO</summary><p>[Desarrollo]</p></details>
                """
