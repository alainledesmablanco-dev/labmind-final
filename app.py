...
def extraer_y_dibujar_bboxes(texto, img_pil):
    ...
    # --- Filtro inteligente para borrar BBOX duplicados ---
...
with col_c:
    ...
    # --- CONTEXTO HOSPITALIZACIÓN POR DEFECTO ---
    ...
    if btn_analizar:
        ...
        with st.spinner("Procesando datos (Razonamiento en Cadena activado)..."):
            try:
                ...
                # --- PROMPT MAESTRO CON RAZONAMIENTO EN CADENA (CoT) Y ENFERMERÍA ---
                if sam_utilizado:
                ...
                <details class="pocus-box" open><summary>👩‍⚕️ CUIDADOS DE ENFERMERÍA</summary><p>[Plan de cuidados específicos: monitorización, curas, apósitos sugeridos, posición del paciente, etc.]</p></details>
