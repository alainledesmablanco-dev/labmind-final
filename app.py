...
# --- CONFIGURACIÓN ---
st.set_page_config(page_title="LabMind 91.5 (Gemini 3.1 Flash)", page_icon="🧬", layout="wide")
...
st.title("🩺 LabMind 91.5 (Gemini 3.1 Flash)")
        ...
        if btn_analizar:
            ...
            with st.spinner(f"🧠 Computando Biomecánica Autónoma ({modo})..."):
                ...
                try:
                    ...
                    # CAMBIO AL MODELO GEMINI 3.1 FLASH PREVIEW
            ...
            with st.expander("💬 Chat Asistente", expanded=False):
                ...
                if p := st.chat_input("Dudas sobre este caso..."):
                    ...
                    with st.chat_message("assistant"):
                        try:
                            # CAMBIO AL MODELO GEMINI 3.1 FLASH PREVIEW EN EL CHAT
                            r = genai.GenerativeModel("gemini-3.1-flash-preview").generate_content(f"CTX:{st.session_state.resultado_analisis}\nQ:{p}")
