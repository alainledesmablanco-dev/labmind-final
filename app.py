...
# --- CONFIGURACIÓN ---
st.set_page_config(page_title="LabMind 94.3 (Mobile Canvas)", page_icon="🧬", layout="wide")
    ...
    if modo == "📚 Agente Investigador (PubMed)":
        ...
        if archivos and any(t == "img" for t, _ in archivos):
            ...
            if habilitar_dibujo:
                ...
                # Ancho adaptado a la pantalla del iPhone 13 mini
                w_canvas = 350
                h_canvas = int(w_canvas * img_pil_original.height / img_pil_original.width)
                
                # Redimensionar la imagen temporalmente para que la pizarra no se sature
                ...
                # Fusionar el dibujo pequeño con la imagen gigante original matemáticamente
                if canvas_result.image_data is not None and np.sum(canvas_result.image_data) > 0:
                    ...
                    st.success("✅ Dibujo fusionado con éxito en alta resolución. La IA lo verá.")
